...
- [Verifying CSS in real headless Chrome](project_headless-chrome-css-verification.md) — how to measure scroll-driven/SVG rendering with the installed Chrome + sharp; `--screenshot` ignores document scroll.
