...
- 6 React Islands con interactividad (todas `client:visible`): MobileMenu, SiteSearch (diálogo de búsqueda con Pagefind), ContactForm, InscriptionForm, ImageLightbox, TrochaVerdeMap (mapa Leaflet — revisar navegación por teclado y alternativa textual)
