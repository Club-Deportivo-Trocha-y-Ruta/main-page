...
const programs = defineCollection({
  ...
  schema: z.object({
    ...
    // Mismo horario en datos, opcional. Alimenta countWeeklySessions() en
    // src/lib/programs.ts; las aclaraciones del club ("salida", "+12 años")
    // siguen viviendo solo en `schedule`.
