...
<!-- =====================================================================
     PLANTILLA FORMATO v3 — CRÓNICA VI VÁLIDA ROLDANILLO
...
<!-- ── BLOQUE 4 · HISTORIAS DEL CLUB ──
     ...
     HILOS ENTRANTES (la pregunta de cada corredor para Roldanillo — retomar
     el que corresponda y cerrarlo o dejarlo avanzado; verificados contra la
     crónica y los PDFs de Palmira):
